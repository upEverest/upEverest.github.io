...
<div class="navigation">  <?=$template['catalog']['name']?></div>
<div class="product">
    ...
    <div class="product_sku">Артикл: <?=$template['product']['sku']?> </div>
    <div class="product_price"> <?=$template['product']['price']?>  руб.  </div>
    <div class="product_desc"> <?=$template['product']['description']?>    </div>
                            <h5 class="product_size"> Размер </h5>
                            <div class="product_size__wrapper">
                            <div class="product_item">
                            <div class="size_text">38</div>
                            </div>
                                                 
                            </div>
                        <div class="product_basket"> Добавить в корзину  </div>
